package com.monosoft.ecommercebenja.presentation.screens.roles.components
...
import com.monosoft.ecommercebenja.domain.model.Rol
    ...
    Column(modifier = Modifier.clickable {
        ...
        AsyncImage(
            modifier = Modifier
                .height(150.dp)
                .width(150.dp),
            model = rol.image,//usamos coil para obtener la imagen por url en segundo plano
            contentDescription = ""
        )
